...
class TestDepositExtra:
    ...
    @allure.story("Смена срока: 3 месяца — проверка бейджа")
    ...
    @allure.tag('ui', 'deposit', 'calculation', 'positive')
    def test_capitalization_toggles_profit_value(self):
        ...
        assert profit_without != profit_with, "Ожидали различие прибыли при капитализации"
